...
public class Adapter_Makanan_Coming extends RecyclerView.Adapter<Adapter_Makanan_Coming.ViewHolder>  {
    private ArrayList<Makanan_Model> listdata;
    private Activity activity;
    private Context context;
    String edit,hapus, detail;
    public Adapter_Makanan_Coming(Activity activity, ArrayList<Makanan_Model> listdata, Context context) {
    ...
    @Override
    public Adapter_Makanan_Coming.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_item_coming_soon, parent, false);
        Adapter_Makanan_Coming.ViewHolder vh = new Adapter_Makanan_Coming.ViewHolder(v);
        return vh;
    }
    @Override
    public void onBindViewHolder(Adapter_Makanan_Coming.ViewHolder holder, int position) {
