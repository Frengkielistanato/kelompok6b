...
<html lang="en">
  <head>
	...
	<link rel="icon" href="images/rantang.png"  >
    ...
    <!-- JQVMap -->
    <link href="<?php echo base_url('assets/jqvmap/dist/jqvmap.min.css') ?>" >
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="" class="site_title"><i class="fa" src="/images/rantang.png"></i> <span>Kantin Sehat</span></a>
            </div>
