...
import com.kantinsehat.kantinsehat.Dashboard.Model.Dashboard_Model;
...
public class Adapter_Makanan extends RecyclerView.Adapter<Adapter_Makanan.ViewHolder>  {
    private ArrayList<Makanan_Model> listdata;
    private Activity activity;
    private Context context;
    String edit,hapus, detail;
    public Adapter_Makanan(Activity activity, ArrayList<Makanan_Model> listdata, Context context) {
    ...
    @Override
    public Adapter_Makanan.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_item_makanan_ready, parent, false);
        Adapter_Makanan.ViewHolder vh = new Adapter_Makanan.ViewHolder(v);
        return vh;
    }
    @Override
    public void onBindViewHolder(Adapter_Makanan.ViewHolder holder, int position) {
